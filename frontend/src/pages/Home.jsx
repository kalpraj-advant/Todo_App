              ...
              <div className="space-y-4 grid grid-cols-3 gap-2">
                ...
                <div className="flex justify-center items-center">
                  <button 
                    ...
                    className={`w-full h-10 bg-blue-600 text-white font-semibold px-6 py-1 rounded-lg transition-colors cursor-pointer mt-3 overflow-hidden ${
                      isAdding || !title.trim() ? "opacity-50 cursor-not-allowed" : "hover:bg-blue-700"
                    }`}
                  >
                    {isAdding ? (
